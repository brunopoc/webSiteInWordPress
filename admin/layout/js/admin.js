...
jQuery("document").ready(function() {
	...
	jQuery("#foliogine_lite_container").fadeIn(200);
  ...
  jQuery("#foliogine_lite_nav li a").live("click",function(){
  ...
  jQuery(".foliogine_lite_save").live("click",function(){
				var b =  jQuery("#foliogine_lite_form").serialize();
				jQuery(".foliogine_lite_save").addClass("button-primary-disabled");
				jQuery(".foliogine_lite_reset").addClass("button-disabled");
				jQuery(".spinner").show();
                jQuery.post( 'options.php', b ).error(
                    function() {
						jQuery(".spinner").hide();
						jQuery(".foliogine_lite_reset").removeClass("button-disabled");
						jQuery(".foliogine_lite_save").removeClass("button-primary-disabled");
                    }).success( function() {
						jQuery(".spinner").hide();
						jQuery(".foliogine_lite_reset").removeClass("button-disabled");
						jQuery(".foliogine_lite_save").removeClass("button-primary-disabled");
  ...
  jQuery(".foliogine_lite_reset").live("click",function(){
				jQuery(".foliogine_lite_reset").addClass("button-disabled");
				jQuery(".foliogine_lite_save").addClass("button-primary-disabled");
				jQuery(".spinner ").show();
			  jQuery.post( ajaxurl,{action:"foliogine_lite_load_defaults"} ).error(
                    function() {
						jQuery(".spinner").hide();
						jQuery(".foliogine_lite_reset").removeClass("button-disabled");
						jQuery(".foliogine_lite_save").removeClass("button-primary-disabled");
  ...
  jQuery(".foliogine_lite_tipsy ").tipsy();
